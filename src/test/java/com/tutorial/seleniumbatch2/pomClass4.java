...
import com.tutorial.pageObjects.contactUsPage;
...
public class pomClass4 {
	...
	public void testCaseExecution() throws InterruptedException {
		...
		cp.creatingCustomerMessage("Customer service","abcd@hotmail.com","1234","NA");
		
		Thread.sleep(3000);
		
		WebElement successAlert= driver.findElement(By.xpath("//*[@class='alert alert-success']"));
